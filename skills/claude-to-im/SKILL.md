...
| Memory/media | QQ group/private limits, `QQ_IMAGE_MAX_BYTES`, SQLite timeout/output caps, unified-memory settings | Validate real paths and size limits. Deliverable task files must remain under the current request's `output/` workspace. |
